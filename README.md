...
[![Build Status](https://github.com/ghaffaria/mattermost-plugin-starter-template/actions/workflows/ci.yml/badge.svg)](https://github.com/ghaffaria/mattermost-plugin-starter-template/actions/workflows/ci.yml)
[![E2E Status](https://github.com/ghaffaria/mattermost-plugin-starter-template/actions/workflows/e2e.yml/badge.svg)](https://github.com/ghaffaria/mattermost-plugin-starter-template/actions/workflows/e2e.yml)
...
```
git clone --depth 1 https://github.com/ghaffaria/mattermost-plugin-starter-template com.example.my-plugin
```
